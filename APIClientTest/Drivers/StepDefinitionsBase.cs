...
using Wakanda.SpecFlow;

namespace APIClientTest
{
    class StepDefinitionsBase : StepsBase
    {
        ...
        /// </summary>
        public StepDefinitionsBase() : base("APIClientTestVault")
        {
            // Get the API key from the secret store
            //var apiKey = _iconfiguration["ScalablePressAPI:TestAPIKey"];
            var apiKey = _iconfiguration["ScalablePressAPI:APIKey"];
        ...
        protected void SetMode(string mode)
        {
            ...
            var apiKey = _iconfiguration[configKey];
